    ...
    function networkConfigurationCtrl( $http, ngTableParams, $mdDialog) {
        ...
        networkConfig.connectionTable = new ngTableParams({}, {
            ...
            getData: function($defer, params) {
                $http.get('modules/network-configuration/network-configuration-data.json/connection.json').then(function(response) {
        ...
        networkConfig.networkTypeTable = new ngTableParams({}, {
            ...
            //Returns the data for rendering
            getData: function($defer, params) {
                $http.get('modules/network-configuration/network-configuration-data.json/networkType.json').then(function(response) {
        ...
        networkConfig.serviceNetwork = new ngTableParams({}, {
            ...
            //Returns the data for rendering
            getData: function($defer, params) {
                $http.get('modules/network-configuration/network-configuration-data.json/serviceNetwork.json').then(function(response) {
        ...
        networkConfig.portForwarding = new ngTableParams({}, {
            ...
            //Returns the data for rendering
            getData: function($defer, params) {
                $http.get('modules/network-configuration/network-configuration-data.json/portForwarding.json').then(function(response) {
        ...
        networkConfig.showAddWifi = function(event) {
            $mdDialog.show({
                ...
                templateUrl: 'modules/network-configuration/view/add-wifi-connection-dialog.tpl.html',
        ...
        networkConfig.showdeleteConform = function(event) {
            $mdDialog.show({
                ...
                templateUrl: 'modules/network-configuration/view/delete-dialog.tpl.html',
                parent: angular.element(document.body),
                targetEvent: event,
                clickOutsideToClose: false,
                fullscreen: networkConfig.customFullscreen // Only for -xs, -sm breakpoints.
